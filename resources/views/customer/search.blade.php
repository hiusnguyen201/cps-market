            ...
            <div class="row">
                                            ...
                                            <form action="" id="price-filter">
                                                <div class="price-input">
                                                    <div class="field">
                                                        ...
                                                        <input type="number" id="price-min" name="price_min"
                                                            class="input-min" value="{{ $price_min ?? 0 }}">
                                                    </div>
                                                    <div class="separator"></div>
                                                    <div class="field">
                                                        <span>Max</span>
                                                        <input type="number" id="price-max" name="price_max"
                                                            class="input-max" value="{{ $price_max ?? 100000000 }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="range-input">
                                                    <div class="u-s-m-b-30">
                                                        <div class="slider">
                                                            @php
                                                                $leftProgress = $price_min
                                                                    ? ($price_min / 100000000) * 100
                                                                    : ($price_min = 1);
                                                                $rightProgress = $price_max
                                                                    ? 100 - ($price_max / 100000000) * 100
                                                                    : 0;
                                                            @endphp
                                                            <div class="progress"
                                                        ...
                                                        <input type="range" class="range-min" min="0"
                                                            max="100000000" value="{{ $price_min ?? 0 }}" step="100000">
                                                        <input type="range" class="range-max" min="0"
                                                            max="100000000" value="{{ $price_max ?? 100000000 }}"
                                                            step="100000">
                                                    </div>
                                                    <button
                ...
                <div class="col-lg-9 col-md-12">
                    <div class="shop-p__meta-wrap u-s-m-b-60">
                        ...
                        <span class="shop-p__meta-text-1">FOUND {{ $countAllProducts ?? 0 }} RESULTS</span>
                                    ...
                                    <div class="tool-style__form-wrap">
                                        <div class="u-s-m-b-8">
                                            <select id="perPageSelect" class="select-box select-box--transparent-b-2"
                                                name="per_page">
                                                <option value="8" {{ $per_page == 8 ? 'selected' : '' }}>Show: 8
                                                </option>
                                                <option value="12" {{ $per_page == 12 ? 'selected' : '' }}>Show:
                                                    12</option>
                                                <option value="16" {{ $per_page == 16 ? 'selected' : '' }}>Show:
                                                    16</option>
                                                <option value="28" {{ $per_page == 28 ? 'selected' : '' }}>Show:
                                                    28</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="u-s-m-b-8">
                                            <select id="sortBySelect" class="select-box select-box--transparent-b-2"
                                                ...
                                                <option value="latest" {{ $sort_by == 'latest' ? 'selected' : '' }}>
                                                    Sort By: Latest Items</option>
                                                <option value="lowest_price"
                                                    {{ $sort_by == 'lowest_price' ? 'selected' : '' }}>Sort By: Lowest
                                                    Price</option>
                                                <option value="highest_price"
                                                    {{ $sort_by == 'highest_price' ? 'selected' : '' }}>Sort By:
                                        ...
                                        <div class="product-m">
                                            ...
                                            <div class="product-m__content">
                                                ...
                                                <div class="product-m__price">
                                                    <span style="color: #ff4500;font-size:16px;">@convertCurrency($product->sale_price)</span>
                                                        ...
                                                        @if (in_array($product->id, array_values($wishlists)))
                                                            ...
                                                            <form action="/wishlist" method="post">
                                                                ...
                                                                <input type="hidden" name="wishlist_id"
                                                                    value="{{ $wishlist_id }}">
                                                                <button id="addToWishlist" class="pd-detail__click-wrap"
                                                                    type="submit" data-tooltip="tooltip"
                                                                    data-placement="top" title="Remove Wishlist">
