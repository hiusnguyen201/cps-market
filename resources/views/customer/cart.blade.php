...
@section('content')
    ...
    <div class="section__intro u-s-m-b-45">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
    ...
    @if ($cartItems->Count() > 0)
        <div class="section__content u-s-m-b-60">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                                        ...
                                        <tr data-cart-id="{{ $item->id }}">
                                                ...
                                                <div class="table-p__box">
                                                    ...
                                                    <div class="table-p__info">
                                                        ...
                                                        <span class="table-p__category">
                                                            <a
                                                                href="shop-side-version-2.html">{{ $item->model->category->name }}</a>
                                                        </span>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                <span class="table-p__price"
                                                    style="color: #ff4500">{{ number_format($item->model->price, 0, ',', '.') }}&nbsp;₫</span>
                                            </td>
                                            <td class="customtd3">
                                                <span
                                                    class="table-p__price">{{ number_format($item->model->market_price, 0, ',', '.') }}&nbsp;₫</span>
                                            </td>
                                            <td>
                                                <div class="input-counter">
                                                    ...
                                                    <input class="input-counter__text input-counter--text-primary-style"
                                                        type="text" name="quantity" value="{{ $item->qty }}"
                                                        data-min="1" data-max="{{ $item->model->quantity }}"
                                                        onchange="updateQty(this)" data-cart-id="{{ $item->rowId }}">
                                        ...
                                        <div class="u-s-m-b-30">
                                            <table class="f-cart__table">
                                                <tbody>
                                                    <tr>
                                                        <td>GRAND TOTAL</td>
                                                        <td id="totalPriceDisplay">{{ Cart::subtotal() }}&nbsp;₫</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
    ...
    @else
        <div class="u-s-m-b-60 text-center" style="margin-bottom: 50px; min-height:450px">
