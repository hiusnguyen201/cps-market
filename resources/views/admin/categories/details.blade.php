                ...
                <div class="col-sm-8">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $index + 1 }}</td>
                                <td><a class="" href="/admin/brands/details/{{ $brand->id }}">{{ $brand->name }}</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
                ...
                <div class="col-sm-8">
                    <div class="d-flex mb-2">
                        <div class="col-2 px-0 mr-2">
                            <a href="/admin/categories/{{ $category->id }}/specifications/create" class="btn btn-success w-100 py-2">Create</a>
                        </div>
                        <div class="col-2 px-0 mr-2">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="align-middle">
                                    <input type="checkbox" class="form-check-input" name="id" value="{{ $specification->id }}">
                                </td>
                                ...
                                <td class="text-center align-middle">
                                    <a class="btn btn-warning" href="/admin/categories/{{ $category->id }}/specifications/edit/{{ $specification->id }}">
                                        <i class="fas fa-pen"></i>
                                    </a>
                                    <button type="button" class="btn btn-danger mt-2" data-toggle="modal" data-target="#modal-delete-{{ $specification->id }}">
                                        <i class="fas fa-trash-alt"></i>
                                    </button>
                                </td>
                            </tr>
                            <div class="modal" id="modal-delete-{{ $specification->id }}" aria-modal="true" role="dialog">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer justify-content-between">
                                            ...
                                            <form action="/admin/categories/{{ $category->id }}/specifications" method="POST">
...
<div class="modal " id="modal-deleteAll" aria-modal="true" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-between">
                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                <form class="form-delete-all" action="/admin/categories/{{ $category->id }}/specifications" method="POST">
