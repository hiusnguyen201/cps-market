    ...
    <form action="" class="d-flex align-items-center mb-2" method="GET">
        ...
        <div class="col-3 px-0 ml-auto">
            <div class="form-group d-flex mb-0">
                <input class="form-control" name="keyword" id="" placeholder="Search by keyword" value="{{ request()->keyword }}">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-right">
                        ...
                        <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#modal-delete-{{ $brand->id }}">
