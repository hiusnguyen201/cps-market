...
@section('content')
    <div class="card py-3 px-3">
        <form class="form-update-all" action="" method="POST">
            ...
            <div class="form-group">
                <label for="attribute"><span class="mr-2">Attribute</span><button type="button" class="btn btn-primary"
                        id="addAttribute">+</button></label>
            ...
            <div class="row">
                <div class="col-lg-6 col-12">
                    <button type="submit" class="btn btn-success py-2 w-100 mb-3">Save</button>
                </div>
                <div class="col-lg-6 col-12">
