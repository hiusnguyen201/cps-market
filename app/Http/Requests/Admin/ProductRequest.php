...
class ProductRequest extends FormRequest
{
    ...
    public function rules(Request $request)
    {
        return [
            ...
            'market_price' => "required|integer|min:1|lte:price",
            'price' => "required|integer|min:1",
            'sale_price' => "nullable|integer|min:1|lte:price|gte:market_price",
    ...
    public function messages()
    {
        return [
            ...
            'market_price.lte' => ":attribute must be lower than price",
            ...
            'sale_price.lte' => ":attribute must be lower than price",
            'sale_price.gte' => ":attribute must be greater than market price",
